#ifndef _h_test_d6a5b3c0_b15d_11ea_b252_a85e451255ad_
#define _h_test_d6a5b3c0_b15d_11ea_b252_a85e451255ad_
...
/*this cb code is codegen by abelkhan for cpp*/
    ...
    public:
        ...
        std::shared_ptr<cb_test3> test3(test2 t2){
            auto uuid_d6a65000_b15d_11ea_b67c_a85e451255ad = boost::lexical_cast<std::string>(boost::uuids::random_generator()());
            rapidjson::Document _argv_d6a65001_b15d_11ea_8766_a85e451255ad;
            rapidjson::Document::AllocatorType& allocator = _argv_d6a65001_b15d_11ea_8766_a85e451255ad.GetAllocator();
            _argv_d6a65001_b15d_11ea_8766_a85e451255ad.SetArray();
            rapidjson::Value str_uuid(rapidjson::kStringType);
            str_uuid.SetString(uuid_d6a65000_b15d_11ea_b67c_a85e451255ad.c_str(), uuid_d6a65000_b15d_11ea_b67c_a85e451255ad.size());
            _argv_d6a65001_b15d_11ea_8766_a85e451255ad.PushBack(str_uuid, allocator);
            _argv_d6a65001_b15d_11ea_8766_a85e451255ad.PushBack(test2::test2_to_protcol(t2));
            call_module_method("test3", _argv_d6a65001_b15d_11ea_8766_a85e451255ad.GetArray());

            var cb_test3_obj = std::make_shared<cb_test3>();
            rsp_cb_test_handle->map_test3.insert(std::make_pair(uuid_d6a65000_b15d_11ea_b67c_a85e451255ad, cb_test3_obj));
            return cb_test3_obj;
        }

        void test4(std::vector<test2> argv){
            rapidjson::Document _argv_d6a65002_b15d_11ea_a78d_a85e451255ad;
            rapidjson::Document::AllocatorType& allocator = _argv_d6a65002_b15d_11ea_a78d_a85e451255ad.GetAllocator();
            _argv_d6a65002_b15d_11ea_a78d_a85e451255ad.SetArray();
            rapidjson::Value _array_d6a65003_b15d_11ea_97d0_a85e451255ad(rapidjson::kArrayType);
            for(auto v_d6a65004_b15d_11ea_bc58_a85e451255ad : _name){
                _array_d6a65003_b15d_11ea_97d0_a85e451255ad.PushBack(test2::test2_to_protcol(v_d6a65004_b15d_11ea_bc58_a85e451255ad), allocator);
            }
            _argv_d6a65002_b15d_11ea_a78d_a85e451255ad.PushBack(_array_d6a65003_b15d_11ea_97d0_a85e451255ad, allocator);
            call_module_method("test4", _argv_d6a65002_b15d_11ea_a78d_a85e451255ad.GetArray());
        }
...
/*this module code is codegen by abelkhan codegen for cpp*/
    ...
    public:
        ...
        rsp(test1 t1){
            rapidjson::Document _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad;
            rapidjson::Document::AllocatorType& allocator = _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad.GetAllocator();
            _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad.SetArray();
            rapidjson::Value str_uuid(rapidjson::kStringType);
            str_uuid.SetString(uuid.c_str(), uuid.size());
            _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad.PushBack(str_uuid, allocator);
            _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad.PushBack(test1::test1_to_protcol(t1), allocator);
            call_module_method("test3_rsp", _argv_d6a65005_b15d_11ea_b5c3_a85e451255ad.GetArray());
        }

        err(int32_t err){
            rapidjson::Document _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad;
            rapidjson::Document::AllocatorType& allocator = _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad.GetAllocator();
            _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad.SetArray();
            rapidjson::Value str_uuid(rapidjson::kStringType);
            str_uuid.SetString(uuid.c_str(), uuid.size());
            _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad.PushBack(str_uuid, allocator);
            _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad.PushBack(err, allocator);
            call_module_method("test3_err", _argv_d6a65006_b15d_11ea_b2f3_a85e451255ad.GetArray());
        }
    ...
    public:
        ...
        void test4(rapidjson::Value& inArray){
            ...
            for(auto it_d6a65007_b15d_11ea_91b7_a85e451255ad = inArray[0].Begin(); itd6a65007_b15d_11ea_91b7_a85e451255ad != inArray[0].End(); ++itd6a65007_b15d_11ea_91b7_a85e451255ad){
                _argv.push_back(test2::protcol_to_test2(it_d6a65007_b15d_11ea_91b7_a85e451255ad));
            }
...
#endif //_h_test_d6a5b3c0_b15d_11ea_b252_a85e451255ad_
