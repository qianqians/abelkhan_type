...
export class rsp_cb_test extends abelkhan.Imodule {
    ...
    public test3_rsp(inArray:any[]){
        let uuid = inArray[0];
        let _argv_716e1a8f_af7f_11ea_b807_a85e451255ad:any[] = [];
        _argv_716e1a8f_af7f_11ea_b807_a85e451255ad.push(protcol_to_test1(inArray[1]));
        var rsp = this.map_test3.get(uuid);
        rsp.event_test3_handle_cb.apply(null, _argv_716e1a8f_af7f_11ea_b807_a85e451255ad);
        this.map_test3.delete(uuid);
    }
    public test3_err(inArray:any[]){
        let uuid = inArray[0];
        let _argv_716eddde_af7f_11ea_8363_a85e451255ad:any[] = [];
        _argv_716eddde_af7f_11ea_8363_a85e451255ad.push(inArray[1]);
        var rsp = this.map_test3.get(uuid);
        rsp.event_test3_handle_err.apply(null, _argv_716eddde_af7f_11ea_8363_a85e451255ad);
        this.map_test3.delete(uuid);
    }
}
...
export class test_caller extends abelkhan.Icaller {
    ...
    public test3(t2:test2){
        let uuid_716edddf_af7f_11ea_8a2f_a85e451255ad = uuidv1();

        let _argv_716edde0_af7f_11ea_a216_a85e451255ad:any[] = [uuid_716edddf_af7f_11ea_8a2f_a85e451255ad];
        _argv_716edde0_af7f_11ea_a216_a85e451255ad.push(test2_to_protcol(t2));
        this.call_module_method("test3", _argv_716edde0_af7f_11ea_a216_a85e451255ad);

        let cb_test3_obj = new cb_test3();
        if (rsp_cb_test_handle){
            rsp_cb_test_handle.map_test3.set(uuid_716edddf_af7f_11ea_8a2f_a85e451255ad, cb_test3_obj);
        }
        return cb_test3_obj;
    }

    public test4(argv:test2[]){
        let _argv_716edde1_af7f_11ea_b2be_a85e451255ad:any[] = [];
        let _array_716edde2_af7f_11ea_bf96_a85e451255ad:any[] = [];
        for(let v_716edde3_af7f_11ea_a6a9_a85e451255ad of _name){
            _array_716edde2_af7f_11ea_bf96_a85e451255ad.push(test2_to_protcol(v_716edde3_af7f_11ea_a6a9_a85e451255ad));
        }
        _argv_716edde1_af7f_11ea_b2be_a85e451255ad.push(_array_716edde2_af7f_11ea_bf96_a85e451255ad);
        this.call_module_method("test4", _argv_716edde1_af7f_11ea_b2be_a85e451255ad);
    }
...
export class rsp_test3 extends abelkhan.Icaller {
    ...
    public rsp(t1:test1){
        let _argv_716edde5_af7f_11ea_a7e5_a85e451255ad:any[] = [this.uuid];
        _argv_716edde5_af7f_11ea_a7e5_a85e451255ad.push(test1_to_protcol(t1));
        this.call_module_method("test3_rsp", _argv_716edde5_af7f_11ea_a7e5_a85e451255ad);
    }

    public err(err:number){
        let _argv_716edde6_af7f_11ea_8f86_a85e451255ad:any[] = [this.uuid];
        _argv_716edde6_af7f_11ea_8f86_a85e451255ad.push(err);
        this.call_module_method("test3_err", _argv_716edde6_af7f_11ea_8f86_a85e451255ad);
    }
...
export class test_module extends abelkhan.Imodule {
    ...
    test3(inArray:any[]){
        ...
        let _argv_716edde4_af7f_11ea_9672_a85e451255ad:any[] = [];
        _argv_716edde4_af7f_11ea_9672_a85e451255ad.push(protcol_to_test2(inArray[1]));
        this.rsp = new rsp_test3(this.current_ch, _cb_uuid);
        if (cb_test3){
            cb_test3.apply(null, _argv_716edde4_af7f_11ea_9672_a85e451255ad);
        }
        this.rsp = null;
    }
    ...
    test4(inArray:any[]){
        let _argv_716edde7_af7f_11ea_b24f_a85e451255ad:any[] = [];
        let _array_716edde8_af7f_11ea_9cd5_a85e451255ad:any[] = [];        for(let v_716edde9_af7f_11ea_bbfa_a85e451255ad of inArray[0]){
            _array_716edde8_af7f_11ea_9cd5_a85e451255ad.push(protcol_to_test2(v_716edde9_af7f_11ea_bbfa_a85e451255ad));
        }
        _argv_716edde7_af7f_11ea_b24f_a85e451255ad.push(_array_716edde8_af7f_11ea_9cd5_a85e451255ad);
        if (this.cb_test4){
            this.cb_test4.apply(null, _argv_716edde7_af7f_11ea_b24f_a85e451255ad);
        }
    }
